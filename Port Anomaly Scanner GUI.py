...
#base_scan = tk.Label(root, text='SELECT BASE PORT SCAN', font = "none 10 bold", anchor="nw", bg="#C0c0c0")
#base_scan.grid(column=0, row=0)
...
#new_scan = tk.Label(root, text='SELECT NEW PORT SCAN', font = "none 10 bold", anchor="nw", bg="#C0c0c0")
#new_scan.grid(column=0, row=2)
